...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupJwtAutoLogin() {
        var originalExecute = window.ui.execute;

        window.ui.execute = function(args) {
            var result = originalExecute.apply(this, arguments);

            if (args && args.spec && args.spec.path === '/api/login' && args.spec.method === 'post') {
